...
mod cut_in_scenario_tests {
    ...
    fn can_roundtrip_cut_in_scenario() {
        ...
        let original_names: std::collections::HashSet<_> = scenario
            .entities
            .scenario_objects
            .iter()
        ...
        let roundtrip_names: std::collections::HashSet<_> = roundtrip_scenario
            .entities
            .scenario_objects
            .iter()
            .filter_map(|obj| obj.get_name())
...
fn tdd_can_parse_simulation_time_conditions() {
    ...
    let condition_group = &scenario.storyboard.stories[0].acts[0].maneuver_groups[0].maneuvers[0]
        .events[0]
        .start_trigger
        .as_ref()
        .unwrap()
