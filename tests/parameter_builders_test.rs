...
mod parameter_builder_tests {
    use openscenario_rs::builder::{
        ScenarioBuilder, ParameterDeclarationsBuilder, ParameterizedValueBuilder, ParameterContext
    };
    ...
    fn test_parameterized_value_builder() {
        ...
        match expr_value {
            openscenario_rs::types::basic::Value::Expression(expr) => assert_eq!(expr, "$speed * 2"),
    ...
    fn test_parameter_utils() {
        ...
        assert_eq!(utils::extract_parameter_name("${vehicle_name}"), Some("vehicle_name"));
        ...
        match param_string {
            openscenario_rs::types::basic::Value::Parameter(name) => assert_eq!(name, "vehicle_name"),
            _ => panic!("Expected parameter reference"),
        }
