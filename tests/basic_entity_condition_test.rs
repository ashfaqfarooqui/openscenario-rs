...
use openscenario_rs::types::{basic::Double, conditions::ByEntityCondition, enums::Rule};
...
fn test_by_entity_condition_variants() {
    ...
    let speed_condition =
        ByEntityCondition::Speed(openscenario_rs::types::conditions::SpeedCondition {
    ...
    let _test_variants = |condition: ByEntityCondition| match condition {
