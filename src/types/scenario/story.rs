...
mod tests {
    ...
    fn test_maneuver_group_with_actors() {
        ...
        assert_eq!(maneuver_group.maximum_execution_count.as_ref().unwrap().as_literal().unwrap(), &3);
    ...
    fn test_event_with_action() {
        ...
        assert_eq!(event.maximum_execution_count.as_ref().unwrap().as_literal().unwrap(), &5);
    ...
    fn test_actors_entity_selection() {
        ...
        assert_eq!(actors.entity_refs[0].entity_ref.as_literal().unwrap(), "Vehicle1");
    }
