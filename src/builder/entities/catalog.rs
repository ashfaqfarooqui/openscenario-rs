...
impl<'parent> CatalogVehicleReferenceBuilder<'parent> {
    ...
    pub fn new(parent: CatalogVehicleBuilder<'parent>, catalog_name: &str, entry_name: &str) -> Self {
    ...
    pub fn finish(mut self) -> BuilderResult<&'parent mut ScenarioBuilder<HasEntities>> {
        ...
        let mut catalog_builder = self.parent.catalog_builder
            .ok_or_else(|| BuilderError::validation_error("Catalog builder not set. Use .with_catalog_builder() first"))?;
...
impl<'parent> CatalogPedestrianReferenceBuilder<'parent> {
    ...
    pub fn new(parent: CatalogPedestrianBuilder<'parent>, catalog_name: &str, entry_name: &str) -> Self {
