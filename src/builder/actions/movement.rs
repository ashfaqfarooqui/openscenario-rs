...
use crate::types::{
    ...
    actions::{
        ...
        LaneOffsetAction, movement::TransitionDynamics, movement::SpeedActionTarget, 
        movement::AbsoluteTargetSpeed, movement::RelativeTargetSpeed, LaneChangeTarget, 
        ...
        LateralActionChoice, movement::LongitudinalActionChoice,
