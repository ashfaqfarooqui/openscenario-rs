...
// TODO: Add other global action builders (EntityAction, TrafficAction, etc.) in future iterations
...
mod tests {
    ...
    fn test_environment_action_builder() {
        ...
        assert_eq!(action.environment_action.unwrap().environment.name, "TestEnvironment");
    }
}